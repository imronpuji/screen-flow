...
- [~] 9. Editor ringan — trim sliders + auto-zoom/cursor/background/camera toggles; trim baked ke export MP4; timeline clip markers (zoom/click seek); per-click zoom points (toggle + scale); **add-at-playhead (Z)**; **focus nudge**; background presets still open
