...
- [~] 4. Preview & playback — live `<video>` + post-record auto-zoom preview
- [~] 5. Auto-zoom — engine + playback preview done; bake into export belum
- [ ] 6. Cursor smoothing + efek klik
- [ ] 7. Background estetik (gradient, padding, rounded, shadow)
- [ ] 8. Editor ringan (timeline trim/zoom/background)
