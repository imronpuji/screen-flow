...
- [~] 5. ⭐ Auto-zoom PRESISI — engine + preview + export bake + Retina/DIP mapping + anti-jitter merge/retarget + per-click enable/scale edits + **add zoom at playhead (Z)**
...
- [~] 9. Editor ringan — trim sliders + auto-zoom/cursor/background/camera toggles; trim baked ke export MP4; timeline clip markers (zoom/click seek); per-click zoom points (toggle + scale); **add-at-playhead (Z)**; focus nudge still open
